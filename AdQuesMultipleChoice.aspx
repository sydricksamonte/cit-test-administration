<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdQuesMultipleChoice.aspx.cs" Inherits="InsExamScore" %>
...
<body>
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Style="font-family: Calibri;
            position: absolute; top: 6px; z-index: 100; left: 8px;" Text="Multiple Choice Questions" Font-Size="X-Large"></asp:Label>
        &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
        ...
        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="Medium"
            Style="z-index: 104; left: 448px; position: absolute; top: 104px" Text="(ALL COURSES)"></asp:Label>
        ...
        <asp:LinkButton ID="LinkButton3" runat="server" Font-Names="Calibri" ForeColor="LimeGreen"
            PostBackUrl="~/AdQuesToF.aspx" Style="z-index: 110; left: 167px; position: absolute;
            top: 87px">True or False</asp:LinkButton>
        <br />
        <br />
        <asp:LinkButton ID="LinkButton5" runat="server" Font-Names="Calibri" ForeColor="LimeGreen"
            PostBackUrl="~/AdQuesIden.aspx" Style="z-index: 111; left: 167px; position: absolute;
            top: 50px">Identification</asp:LinkButton>
        <br />
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ans_a" HeaderText="Correct Choice" SortExpression="ans_a" />
                <asp:BoundField DataField="ans_b" HeaderText="Choice #2" SortExpression="ans_b" />
                <asp:BoundField DataField="ans_d" HeaderText="Choice #3" SortExpression="ans_d" />
                <asp:BoundField DataField="ans_c" HeaderText="Choice #4" SortExpression="ans_c" />
                <asp:BoundField DataField="ans_e" HeaderText="Choice #5" SortExpression="ans_e" />
