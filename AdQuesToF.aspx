<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdQuesToF.aspx.cs" Inherits="InsExamScore" %>
...
<body>
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Style="font-family: Calibri;
            position: absolute; top: 6px; z-index: 100; left: 8px;" Text="True or False Questions" Font-Size="X-Large"></asp:Label>
        &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ans_a" HeaderText="Correct" SortExpression="ans_a" />
                <asp:BoundField DataField="ans_b" HeaderText="Incorrect" SortExpression="ans_b" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:JOELCONN %>"
            SelectCommand="SELECT ques_desc, ans_a, ans_b, ques_id, l_o, c_o FROM question_table WHERE (typeEx = @typeEx) AND (copy_type = @copy_type) AND (l_outcomes LIKE '%' + @l_outcomes + '%')" DeleteCommand="DELETE FROM [question_table] WHERE [ques_id] = @ques_id" InsertCommand="INSERT INTO [question_table] ([ques_desc], [ans_a], [ans_b], [ans_c], [ans_d], [ans_e], [ques_id], [l_o], [c_o]) VALUES (@ques_desc, @ans_a, @ans_b, @ans_c, @ans_d, @ans_e, @ques_id, @l_o, @c_o)" UpdateCommand="UPDATE [question_table] SET [ques_desc] = @ques_desc, [ans_a] = @ans_a, [ans_b] = @ans_b, [ans_c] = @ans_c, [ans_d] = @ans_d, [ans_e] = @ans_e, [l_o] = @l_o, [c_o] = @c_o WHERE [ques_id] = @ques_id">
            <SelectParameters>
