...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
       <asp:DropDownList ID="asa" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource7"
        DataTextField="term" DataValueField="term" 
      Style="z-index: 106;
        left: 228px; position: absolute; top: 190px" Width="92px" OnDataBound="asa_DataBound">
    </asp:DropDownList>
    <asp:Panel ID="Panel3" runat="server" Height="193px"
        Style="left: 185px; color: white; font-family: ~/DroidSans.ttf, 'Lucida Sans';
        position: absolute; top: 230px; z-index: 100;" Width="193px">
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RACHELCONN %>"
            ...
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="asa" Name="exname" PropertyName="SelectedValue"
                    Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        &nbsp; &nbsp;
        ...
        <asp:Button ID="Button7" runat="server" Font-Names="Calibri" Font-Size="Small" Height="24px"
            Style="left: 49px; position: absolute; top: 134px" Text="Generat Seatwork/Quiz" Width="218px" Enabled="False" OnClick="Button_Clickn" ToolTip="If you want to generate a test with a single set only, Choose this button." /><asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True"
        ...
        <asp:Button ID="Button2" runat="server" Font-Names="Calibri" Font-Size="Small" Height="24px"
            Style="left: 49px; position: absolute; top: 78px" Text="Generate Exam (Set A / Single Set)" Width="218px" Enabled="False" OnClick="Button2_Click" ToolTip="If you want to generate a test with only a single set, Choose this." />
        <asp:Button ID="Button5" runat="server" Font-Names="Calibri" Font-Size="Small" Height="24px"
            Style="left: 49px; position: absolute; top: 103px" Text="Generat Exam (Set B)" Width="218px" Enabled="False" OnClick="Button_Click" ToolTip="If you want to generate a test with a single set only, Choose this button." />
    </asp:Panel>
    <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="~/DroidSans.ttf"
        ...
        font-family: Calibri; position: absolute; top: 8px; z-index: 101;" Text="Reports" Visible="False"
    ...
    <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="~/DroidSans.ttf"
        ...
        font-family: Calibri; position: absolute; top: 253px; z-index: 102;" Text="Reports" Visible="False"
        Width="45px"></asp:Label>
    <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Names="~/DroidSans.ttf"
        ...
        font-family: Calibri; position: absolute; top: 278px; z-index: 103;" Text="Reports" Visible="False"
        Width="45px"></asp:Label>
    <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Names="~/DroidSans.ttf"
        ...
        font-family: Calibri; position: absolute; top: 333px; z-index: 104;" Text="Reports" Visible="False"
        ...
        position: absolute; top: 208px; z-index: 105;" Width="50px">
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:CIT examsConnectionString33 %>"
            ...
            SelectCommand="SELECT DISTINCT [course_id] FROM [course] WHERE (([sec_handler] = @sec_handler) AND ([term] = @term)) ORDER BY [course_id]">
                <SelectParameters>
                    <asp:SessionParameter Name="sec_handler" SessionField="user" Type="String" />
                    <asp:ControlParameter ControlID="asa" Name="term" PropertyName="SelectedValue" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            ...
            top: 66px" Width="81px" AutoPostBack="True" OnDataBound="DropDownList2_DataBound" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged">
            </asp:DropDownList>
            <asp:Label ID="Label18" runat="server" Font-Bold="False" Font-Size="Small" Height="19px"
                Style="font-size: small; left: 155px; color: limegreen; font-family: 'Lucida Sans';
            ...
            Style="left: 211px; position: absolute; top: 66px" Width="74px" Enabled="False">
            </asp:DropDownList>
        ...
        <asp:Button ID="Button11" runat="server" Font-Names="Calibri" Font-Size="Small" Height="29px"
            ...
            OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Style="left: 76px;
            position: absolute; top: 129px" Width="194px">
            </asp:DropDownList>
        <asp:Label ID="Label14" runat="server" Font-Bold="True" Font-Names="~/DroidSans.ttf"
            Height="19px" Style="font-weight: normal; font-size: medium; left: 22px; color: limegreen;
            font-family: Calibri; position: absolute; top: 130px" Text="Exams" Width="32px"></asp:Label>
        <asp:Button ID="Button9" runat="server" Font-Names="Calibri" Font-Size="Small" Height="29px"
            Style="left: 90px; position: absolute; top: 95px" Text="Generate Scores"
        ...
        <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource2"
            ...
            top: 281px" Width="96px" AutoPostBack="True" OnDataBound="DropDownList3_DataBound">
        </asp:DropDownList>
        &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        ...
        <asp:Button ID="Button12" runat="server" Font-Names="Calibri" Font-Size="Small" Height="33px"
            Style="left: 60px; position: absolute; top: 172px" Text="Generate Item Analysis (Summary)"
            ...
            Style="left: 61px; position: absolute; top: 208px" Text="Generate Item Analysis (Full)"
        ...
        <asp:Button ID="Button14" runat="server" Font-Names="Calibri" Font-Size="Small" Height="29px"
            ...
            Width="147px" Enabled="False" OnClick="Button3_Click" Visible="False" />
            &nbsp;
            <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:RACHELCONN %>"
            SelectCommand="SELECT pname, exname FROM exams WHERE (user_id = @user_id) AND (exname LIKE '%' + @exname + '%') AND (frameA NOT LIKE '[PRINT ]%') ORDER BY pub_date">
                <SelectParameters>
                    <asp:SessionParameter Name="user_id" SessionField="user" Type="String" />
    ...
    &nbsp;
    <asp:Label ID="Label20" runat="server" Font-Size="Medium" Style="left: 192px; color: limegreen;
        font-family: Calibri; position: absolute; top: 191px; z-index: 107;">Term</asp:Label>
